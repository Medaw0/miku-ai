// server.js - Debug ve timeout eklenmiş MikuAI Server
...
async function sendToAI(prompt) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            console.error("❌ AI API returned error:", response.status, text);
            return null;
        }
...
app.post("/ai", async (req, res) => {
    ...
    if (!aiReply) {
        console.log("⚠️ AI request failed, sending error to client");
